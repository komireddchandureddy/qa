...
public class IGP_TC_201 extends KeywordUtil {
	String stepInfo = "";
	int retryCount = getIntValue("retryCount");
	static int retryingNumber = 1;

	@Test(testName = "IGP_TC_201", groups = {
			"Payment" }, description = "Credit Card & Debit card: Card Number field -:Ensure  that if the user provides wrong card number it has to give error.")
	public void test() throws Throwable {
		try {
			...
			stepInfo = "Enter invalid debit card number and verify error";
			logStep(stepInfo);
