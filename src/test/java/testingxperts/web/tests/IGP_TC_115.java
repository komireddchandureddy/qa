...
public class IGP_TC_115 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Shipping options should be visible: Ensure that shipping option should be visible for India."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			stepInfo="Click on Flowers and Gifts from HomePage.";
			logStep(stepInfo);
