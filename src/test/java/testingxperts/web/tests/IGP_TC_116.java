...
public class IGP_TC_116 extends KeywordUtil{
	String stepInfo="";
	...
	@Test(
			...
			description="Shipping charges for international delivery: Ensure that there should be Shipping charges for international delivery."
			)
	public void test() throws Throwable {
		try{
			...
			*/
			...
			logStep(stepInfo);
			HomePage.selectNextButton();
			verifyStep(HomePage.selectItemEditorPick(6),stepInfo);
			...
			logStep(stepInfo);
			verifyStep(ProductDetailPage.deliverychargePresent("Japan"), stepInfo);
